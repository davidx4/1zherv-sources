        ...
        { // Main Window Area
            ...
            GUILayout.BeginVertical();
            {
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    var interactivity = GameManager.Instance.interactiveMode;
                    GUILayout.FlexibleSpace();
                    interactivity = GUILayout.Toggle(interactivity, "", GUILayout.ExpandWidth(false));
                    GUILayout.FlexibleSpace();
                    //interactivity = GUI.Toggle (new Rect (25, 25, 100, 30), interactivity, "");
                    
                    if (GUI.changed)
                    { GameManager.Instance.interactiveMode = interactivity; }
                }
                GUILayout.EndHorizontal();
                ...
                GUILayout.BeginHorizontal();
               {
                   ...
                   volume = (int) GUILayout.HorizontalSlider(volume, -80.0f, 20.0f, //<-80.0f, 20.0f>
                       GUILayout.ExpandWidth(true));
                   if (GUI.changed)
                   { SoundManager.Instance.masterVolume = volume; }
                   
                   
                   if (GUILayout.Button("M", GUILayout.ExpandWidth(false), GUILayout.ExpandHeight(true)))
                   {
               ...
               GUILayout.EndHorizontal();
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    if (GUILayout.Button("Enable\nDummy\nCharacter",
                            ...
                            GUILayout.ExpandHeight(true)))
                    {
                        GameManager.Instance.TogglePlayerCharacter(); /* Fill the code here! */
                    }
                }
                GUILayout.EndHorizontal();
